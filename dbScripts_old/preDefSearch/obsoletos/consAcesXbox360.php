<?php
$query = "SELECT id_produto, nome_prod, produtor, preco, qtd_estoque FROM produto WHERE cod_categoria = 6 AND tags LIKE ('%360%') AND tags LIKE ('%xbox%') ORDER BY nome_prod";
