    ...
    <div id="divContent">
        <div class="topBox">
            <div style="display: table; margin: auto;">
                <div id="divLeftMenu">
                    <a href="automotivo.php?unsetPA=1&listProds=0" style="text-decoration: none;">
                        <div class="genericBar" style="width: 250px; margin: 0 5px 10px 0;"><div class="leftMenuTitle">Automotivo</div></div>
                    </a>
                    <div id="accordion">
                        <a href="#" class="subCatBtnBar">Equipamento Veicular</a>
                        <div>
                            <a href="automotivo.php?unsetPA=1&listProds=1"><p class="subCatLink">Som Automotivo</p></a>
                            <a href="automotivo.php?unsetPA=1&listProds=2"><p class="subCatLink">GPS</p></a>
                            <a href="automotivo.php?unsetPA=1&listProds=3"><p class="subCatLink">Acessórios</p></a>
                        </div>
                    </div>
                </div>
                <div id="divSlides">
        ...
        <div class="topBox">
            ...
            if(isset($_GET['listProds'])){
                switch (intval($_GET['listProds'])){
                    case 1:
                        include 'dbScripts/preDefSearch/mkQueryAutoSom.php';
                        unset($_SESSION['prodArray']);
                        break;
                    case 2:
                        include 'dbScripts/preDefSearch/mkQueryGPS.php';
                        unset($_SESSION['prodArray']);
                        break;
                    case 3:
                        include 'dbScripts/preDefSearch/mkQueryAutoAcess.php';
                        unset($_SESSION['prodArray']);
                        break;
                    default :
                        include 'dbScripts/preDefSearch/mkQueryAllAuto.php';
                        unset($_SESSION['prodArray']);
                }
            }else{
            ...
            if(isset($_SESSION['prodArray'])){
                mkNavLinks(count($_SESSION['prodArray']), 30, 'prodListIndex', 'automotivo.php');
            }
            echo '</div>';
            ?>
        </div>
