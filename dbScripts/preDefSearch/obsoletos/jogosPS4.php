<?php
$query = "SELECT id_produto, nome_prod, produtor, preco, qtd_estoque FROM produto WHERE cod_categoria = 14 AND tags LIKE ('%4%') AND tags LIKE ('%playstation%') ORDER BY nome_prod";
