    ...
    <div id="divContent">
        <div class="topBox">
            <div style="display: table; margin: auto;">
                <div id="divLeftMenu">
                    <a href="perfumes.php?unsetPA=1&listProds=0" style="text-decoration: none;">
                        <div class="genericBar" style="width: 250px; margin: 0 5px 10px 0;"><div class="leftMenuTitle">Perfumes</div></div>
                    </a>
                    <div id="accordion">
                        <a href="#" class="subCatBtnBar">Perfumes por Gênero</a>
                        <div>
                            <a href="perfumes.php?unsetPA=1&listProds=1"><p class="subCatLink">Masculino</p></a>
                            <a href="perfumes.php?unsetPA=1&listProds=2"><p class="subCatLink">Feminino</p></a>
                            <a href="perfumes.php?unsetPA=1&listProds=3"><p class="subCatLink">Unisex</p></a>
                        </div>
                    </div>
                </div>
                <div id="divSlides">
        ...
        <div class="topBox">
            ...
            if(isset($_GET['listProds'])){
                switch (intval($_GET['listProds'])){
                    case 1:
                        include 'dbScripts/preDefSearch/mkQueryPerfMasc.php';
                        unset($_SESSION['prodArray']);
                        break;
                    case 2:
                        include 'dbScripts/preDefSearch/mkQueryPerfFem.php';
                        unset($_SESSION['prodArray']);
                        break;
                    case 3:
                        include 'dbScripts/preDefSearch/mkQueryPerfUnisex.php';
                        unset($_SESSION['prodArray']);
                        break;
                    default :
                        include 'dbScripts/preDefSearch/mkQueryAllPerf.php';
                        unset($_SESSION['prodArray']);
                }
            }else{
            ...
            if(isset($_SESSION['prodArray'])){
                mkNavLinks(count($_SESSION['prodArray']), 30, 'prodListIndex', 'perfumes.php');
            }
            echo '</div>';
            ?>
        </div>
